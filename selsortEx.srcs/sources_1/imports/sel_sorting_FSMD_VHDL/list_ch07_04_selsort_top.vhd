...
architecture str_arch of selsort is
   ...
   signal clr_lec, inc_lec, dec_lec, clr_rec, inc_rec, ld_rec, dec_rec: std_logic;
   signal clr_ec, inc_ec, ld_ec, dec_ec: std_logic;
   signal  ld_rer , ld_ler: std_logic;
...
begin
   ...
   lec_cnt_unit: entity work.xec_cnt(arch)
      ...
      port map(
      clk=>clk, reset=>reset,
      clr=>clr_lec, ld=>'0', inc=>inc_lec, dec=>dec_lec,
      d=>rec_value ,
      q=>lec_value   
	  );
...
--	  );
   ...
   ctr_path_unit: entity work.ctr_path(arch)
      port map(
      clk=>clk, reset=>reset,
      clr_lec=>clr_lec, inc_lec=>inc_lec, dec_lec =>dec_lec,
      lec_value=>lec_value, 
